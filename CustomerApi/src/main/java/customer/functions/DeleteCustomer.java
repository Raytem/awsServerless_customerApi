...
public class DeleteCustomer implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        CustomerEntity customer = new CustomerService().delete(customerId);
        if (customer == null) {
